...
public class SkillLearn
{
	...
	public SkillLearn(String _skillName, int _skillId, int _skillLevel, int _getLevel, boolean _autoGet, int _levelUpSp, boolean _residenceSkill, boolean _learnedByNpc, boolean _learnedByFS) {
		this._skillName = _skillName;
		this._skillId = _skillId;
		this._skillLevel = _skillLevel;
		this._getLevel = _getLevel;
		this._autoGet = _autoGet;
		this._levelUpSp = _levelUpSp;
		this._residenceSkill = _residenceSkill;
		this._learnedByNpc = _learnedByNpc;
		this._learnedByFS = _learnedByFS;
	}
